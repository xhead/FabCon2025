CREATE TABLE [dw].[Project] (
    ...
    [Project Manager]     VARCHAR (100) NULL,
    ...
    [RowHash]             AS            (hashbytes('SHA2_512',concat_ws('|',[Project],[Project Code],[Project Description],[Project Start Date],[Project End Date],[Project Status],[Project Manager]))),
